...
@WebServlet(name = "AdminAddTask", urlPatterns = "/profile/admin/tasks/add")
public class AdminAddTask extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("../../../view/admin-add-task.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ((dateBegin.equals(dateNow) || dateBegin.after(dateNow)) && dateEnd.after(dateBegin) &&
            ...
            resp.sendRedirect("/profile/admin/tasks/add");
        }
    }
}
